...
def main(argv):
    try:
        ...
        assert len(argv) >= 3, "Command Line arguments passed not meeting minimum criteria of ExperianTableName, ScanTableName and Yes/No/All Flag for weighted Report !"
